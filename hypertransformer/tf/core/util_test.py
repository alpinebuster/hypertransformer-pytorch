...
class UtilTest(tf.test.TestCase):
    ...
    def test_simple_transformer_io(self):
        ...
        self.assertEqual(encoded.shape, (batch_size, embedding_dim + (image_size**2)))
        self._check_weights(
            encoded, num_weights=num_weights, image_size=image_size, io=io
        )
