...
flags.DEFINE_integer(
    "samples_transformer", 32, "Number of samples fed to the transformer."
)
flags.DEFINE_integer("samples_cnn", 128, "Number of samples fed to the CNN.")
flags.DEFINE_integer(
    "use_labels",
    8,
    "First N labels to use for training "
...
flags.DEFINE_float(
    "lw_inner_dim",
    1.0,
    "Inner transformer dimension of "
...
flags.DEFINE_float(
    "weight_variation_regularization",
    0.0,
...
flags.DEFINE_enum(
    "cnn_activation", "relu", ["relu", "lrelu"], "CNN activation function."
)
flags.DEFINE_bool(
    "transformer_skip_last_nonlinearity",
    False,
