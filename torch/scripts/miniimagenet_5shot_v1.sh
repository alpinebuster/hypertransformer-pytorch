...
# e.g.
#    `nohup ./scripts/miniimagenet_5shot_v1.sh --data_dir=../miniimagenet --data_numpy_dir=../miniimagenet/cache --train_log_dir=../miniimagenet/logs/torch > miniimagenet_5shot.log 2>&1 &`
# 
